...
long initNative(int sampleRate, int channels)
{
...
bool putBytesNative(long sonicID,
    char * buffer,
    int lenBytes)
{
    sonicInst inst = getInst(sonicID);
    ...
    memcpy((char *)inst->byteBuf, buffer, lenBytes);
...
float getPitchNative(long sonicID)
{
    sonicStream stream = getInst(sonicID)->stream;
    LOGV("Reading pitch");
...
// decrease the pitch.
void setRateNative(long sonicID, float newRate)
{
    sonicStream stream = getInst(sonicID)->stream;
...
float getRateNative(long sonicID)
{
    sonicStream stream = getInst(sonicID)->stream;
    LOGV("Reading rate");
...
int getSampleRateNative(long sonicID)
{
    sonicStream stream = getInst(sonicID)->stream;
...
// Set the sample rate.
void setSampleRateNative(long sonicID, int newSampleRate)
{
    sonicStream stream = getInst(sonicID)->stream;
...
int getNumChannelsNative(long sonicID)
{
    sonicStream stream = getInst(sonicID)->stream;
...
void setNumChannelsNative(long sonicID, int newNumChannels)
{
    sonicStream stream = getInst(sonicID)->stream;
...
float getSpeedNative(long sonicID)
{
    sonicStream stream = getInst(sonicID)->stream;
    LOGV("Reading speed");
...
// Change the speed.
void setSpeedNative(long sonicID, float newSpeed)
{
    sonicStream stream = getInst(sonicID)->stream;
...
float getVolumeNative(long sonicID)
{
    sonicStream stream = getInst(sonicID)->stream;
    LOGV("Reading volume");
...
// Change the volume.
void setVolumeNative(long sonicID, float newVolume)
{
    sonicStream stream = getInst(sonicID)->stream;
...
bool getChordPitchNative(long sonicID)
{
    sonicStream stream = getInst(sonicID)->stream;
...
// object
int availableBytesNative(long sonicID)
{
    sonicStream stream = getInst(sonicID)->stream;
